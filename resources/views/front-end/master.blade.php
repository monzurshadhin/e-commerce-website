...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset('frontend-assets')}}/assets/css/font-awesome.min.css">
...
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/{{asset('frontend-assets')}}/assets/js/bootstrap.min.js"></script>

<!-- jQuery sticky menu -->
<script src="{{asset('frontend-assets')}}/assets/js/owl.carousel.min.js"></script>
<script src="{{asset('frontend-assets')}}/assets/js/jquery.sticky.js"></script>
...
<!-- Slider -->
<script type="text/javascript" src="{{asset('frontend-assets')}}/assets/js/bxslider.min.js"></script>
<script type="text/javascript" src="{{asset('frontend-assets')}}/assets/js/script.slider.js"></script>
</body>
</html>
